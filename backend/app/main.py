...
from backend.app.api import auth_router, budget_router, chat_router, multimodal_router, report_router, transaction_router
...
async def lifespan(_app: FastAPI):
    scheduler_task = asyncio.create_task(run_recurring_scheduler())
    try:
        yield
    finally:
...
app = FastAPI(
    title="Vyapar Sathi Unified API",
    version="1.0.0",
    lifespan=lifespan,
)
